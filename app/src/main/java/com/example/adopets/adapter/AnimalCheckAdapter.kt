...
class AnimalCheckAdapter(private val context: Context, private val listAnimais: ArrayList<Animal>) : RecyclerView.Adapter<AnimalCheckAdapter.MyViewHolder>(){

    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): MyViewHolder {
        val view = LayoutInflater.from(viewGroup.context).inflate(R.layout.list_view_animais_checkpoint,viewGroup,false)
