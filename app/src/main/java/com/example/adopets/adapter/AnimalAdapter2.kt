...
class AnimalAdapter2(private val animais: List<Animal>, private val context: Context) : Adapter<AnimalAdapter2.ViewHolder>() {

    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.list_view_animais2, p0, false)
